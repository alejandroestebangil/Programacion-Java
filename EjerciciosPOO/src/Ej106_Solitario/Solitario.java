...
public class Solitario extends Applet implements Runnable{
    ...
    private void setupBaraja() {
        ...
        for (int i = 0; i < NUMCARTAS; i++) {
            imagenes[i] = getImage(getCodeBase(), "Ej106_Solitario/Cartas/" + ((i % CARTASxPALO) + 1) + nombresPalos[i/CARTASxPALO] + ".png");
        }
        imgReverso = getImage(getCodeBase(), "Ej106_Solitario/Cartas/reverso.png");
