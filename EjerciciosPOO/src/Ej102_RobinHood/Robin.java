...
public class Robin extends Applet implements Runnable {
    ...
    public void init(){
        ...
        fondo = getImage(getCodeBase(), "Ej102_RobinHood/Robin/robinhoodFondo.jpg");
        robin = getImage(getCodeBase(), "Ej102_RobinHood/Robin/robin.png");
        flechaImg = getImage(getCodeBase(), "Ej102_RobinHood/Robin/flecha.png");
        globoImg = new Image[NUM_GLOBOS];
        for (int i = 0; i < NUM_GLOBOS; i++) {
            globoImg[i] = getImage(getCodeBase(), "Ej102_RobinHood/Robin/globo" + i + ".png");
        }
